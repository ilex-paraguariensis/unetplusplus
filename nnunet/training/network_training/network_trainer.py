...
class NetworkTrainer(object):
    ...
    def load_pretrained_weights(self, fname):
        ...
        if fine_tune:
            ...
            # print(model_dict)
            print(
                "############################################### Loading pre-trained Models Genesis from ",
                fname,
            )
            print(
                "Below is the list of overlapping blocks in pre-trained Models Genesis and nnUNet architecture:"
            )
    ...
    def load_pretrained_encoder_weights(self, fname):
        ...
        # print(model_dict)
        print(
            "############################################### Loading pre-trained Models Genesis encoder from ",
            fname,
        )
        print(
            "Below is the list of overlapping blocks in pre-trained Models Genesis (encoder) and nnUNet architecture (encoder):"
        )
        for key, _ in pretrained_dict.items():
            print(key)
        print("############################################### Done")
